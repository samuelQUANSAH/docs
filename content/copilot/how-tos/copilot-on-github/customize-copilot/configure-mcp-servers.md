Here is the **clean, finalized** content of the file, with the diff markings completely removed and all corrections fully integrated. 

You can copy and paste this block directly into the editor:
...
1. In the "Model Context Protocol (MCP)" section of the page, add your configuration in the "MCP configuration" text area.
